...
app.config['SECRET_KEY'] = 'dev'  # 等同于 app.secret_key = 'dev'    后面使用flash函数，这里就必须设定session签名的密钥
...
login_manager.login_message = 'You have not logged yet.'
